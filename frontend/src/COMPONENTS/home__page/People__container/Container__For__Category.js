    ...
    return (
        ...
        <div  class="  mx-40 grid grid-cols-6 gap-x-5 gap-y-5 ">
            <div class=" col-start-1 col-end-4 h-96 bg-black text-black rounded-lg ">               
                  <div  className="relative z-30 h-96 object-fit w-full  text-3xl text-white font-black"><h1 id="heading-category" className=" w-auto pb-2 mx-10 pt-80"><Link to="/">Teacher</Link></h1></div>
